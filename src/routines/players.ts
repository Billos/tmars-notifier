...
const lastNotificationId = new Map<string, string>()
...
export async function clearPlayer(user: SimplePlayerModel) {
  ...
  lastNotificationId.delete(user.id)
